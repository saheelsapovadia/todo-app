      ...
      <div className="task-detail-wrapper task-detail">
        <div className="task-detail-container">
          ...
          <div className="action-btns">
            ...
            <button className="add-task-btn" onClick={addNew}>
              save
            </button>
          </div>
        </div>
  ...
  return (
    <div className="task-detail-wrapper task-detail">
      <div className="task-detail-container">
        ...
        <div className="action-btns">
          <button
            className="add-task-btn shadow"
            onClick={() => {
              if (selectedTodo && selectedTodo.uid)
                deleteTodo(selectedTodo.uid);
            }}
          >
            delete
          </button>
          <button className="add-task-btn shadow" onClick={handleUpdateTask}>
            save
          </button>
        </div>
      </div>
